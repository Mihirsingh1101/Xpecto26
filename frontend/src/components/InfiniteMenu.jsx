    ...
    <div className="relative w-full h-full min-h-[400px]">
      ...
      {activeItem && (
        ...
        `}>
          ...
          ${
            isMoving
              ? 'opacity-0 pointer-events-none duration-[100ms] translate-x-[-20%] md:translate-x-[-60%]'
              : 'opacity-100 pointer-events-auto duration-[500ms] translate-x-0 md:translate-x-[-90%]'
          }
        `}>
